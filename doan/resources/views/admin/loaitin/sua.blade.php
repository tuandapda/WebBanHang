      ...
      <div class="row">
        <div class="col-lg-6">  
            <div class="form-group">
              ...
              <input class="form-control"  type="text" name="Ten" value="{{$loaitin->Ten}}"><small class="form-text text-muted" id="emailHelp">We'll never share your email with anyone else.</small>
              <input type="hidden" name="_token" value="{{csrf_token()}}"/>
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Ngày Tạo *</label>
                <input class="form-control" id="exampleInputEmail1" type="date" name="NgayCapNhat" value="{{$loaitin->NgayCapNhat}}">
            </div>
        </div>
      </div>
