      ...
      <div class="row">
        <div class="col-lg-6">  
            <div class="form-group">
                ...
                <input class="form-control" id="exampleInputEmail1" type="text" name="HoTen">
                <input type="hidden" name="_token" value="{{csrf_token()}}"/>
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Điện Thoại *</label>
                <input class="form-control" id="exampleInputEmail1" type="text" name="Dienthoai">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" id="exampleTextarea" rows="5" name="DiaChi"></textarea>
            </div>
        </div>
        <div class="col-lg-4 offset-lg-1">
            <div class="form-group">
              <label class="col-form-label" for="inputDefault">Tài Khoản *</label>
              <input class="form-control" id="inputDefault" type="text" name="TaiKhoan">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control" id="inputDefault"  type="password"name="password_confirmation">
            </div>
            <div class="form-group">
