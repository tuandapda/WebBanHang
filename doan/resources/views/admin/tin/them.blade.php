...
<div class="col-md-12">
    <div class="tile">
        <h3 class="tile-title">Thông Tin</h3>
          ...
          @endif
      <form method="POST" method="POST" action="admin/tin/them" enctype="multipart/form-data">
      <div class="row">
        <div class="col-lg-6">  
            <div class="form-group">
              <label >Tiêu Đề *</label>
              <input class="form-control"  type="text" name="TieuDe"><small class="form-text text-muted" id="emailHelp">We'll never share your email with anyone else.</small>
        ...
        <div class="col-lg-4 offset-lg-1">
            <div class="form-group">
                ...
                <input class="form-control" type="date" name="NgayCapNhat"/>
            </div>
            <div class="form-group">
        ...
        <div class="col-lg-12" >
            <div class="form-group" >
                ...
                <textarea  class="form-control" id="ND_Them" rows="10" name="NoiDung"></textarea>
            </div>
        </div>
      </div>
